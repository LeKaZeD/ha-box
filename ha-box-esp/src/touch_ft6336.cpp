...
bool TouchFT6336::read(State& out)
{
  ...
  // Point1: 0x03..0x06, Point2: 0x09..0x0C (6-byte stride per point)
  static constexpr int POINT1_REG_OFFSET = 0;
  static constexpr int POINT2_REG_OFFSET = 6;
  uint8_t b[12] = {0};
  ...
  out.count = td;
  decodePoint(POINT1_REG_OFFSET, out.p0);
  if (td >= 2) decodePoint(POINT2_REG_OFFSET, out.p1);
